...
public class Day0203 {
	public static void main(String[] args) {
		...
		System.out.println(result4); //숫자뒤에 롱형숫자 영문자L을입력
		
		byte num5 = 15;
		byte num6 = 1;
		int result5 = num5+num6;	//자바의 기본연산은 int입니다. byte+byte의 결과는 int입니다.
...
//		int result8 = 10L;	//long형을 int에 대입할수 없습니다.
		System.out.println(result7);
		int num9 = 10;
		int num10 = 20;
		short result9 = (short)(num9+num10);	//강제형변환,명시적형변환, casting
												//큰자료형을 작은 자료형으로 변환할 때는
												//강제형변환을 해야 합니다.
