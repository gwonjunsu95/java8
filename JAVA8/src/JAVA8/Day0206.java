...
//		char ch2 = 'ab'';	//char형은 2개 이상의 문자를 입력할수 없습니다.
		...
		System.out.println(result8);	//char형에 숫자를 대입하면 그 숫자에 맞는 문자가 출력된다.
		int result9 = 'A';
